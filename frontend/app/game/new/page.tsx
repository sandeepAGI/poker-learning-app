    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-green-700 to-green-900">
        <div className="bg-white p-8 rounded-2xl shadow-2xl max-w-md w-full text-center">
          ...
          <h2 className="text-xl font-bold text-gray-800 mb-2">Setting up your game...</h2>
          <p className="text-gray-600 text-sm">Connecting to server and preparing the table</p>

          {connectionError && (
            <div className="mt-4 bg-red-50 border border-red-500 text-red-700 px-4 py-3 rounded text-sm">
